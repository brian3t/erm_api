<div class="form-group" id="add-mk-internet">
<?php
        ...
        'del' => [
            ...
            'value' => function($model, $key) {
                return
                    ...
                    Html::a('<i class="glyphicon glyphicon-trash"></i>', '#', ['title' =>  'Delete', 'onClick' => 'delRowMkInternet(' . $key . '); return false;', 'id' => 'mk-internet-del-btn']);
            },
        ],
    ],
    'gridSettings' => [
        'panel' => [
            ...
            'before' => false,
            'footer' => false,
            'after' => Html::button('<i class="glyphicon glyphicon-plus"></i>' . 'Add Mk Internet', ['type' => 'button', 'class' => 'btn btn-success kv-batch-create', 'onClick' => 'addRowMkInternet()']),
        ]
    ]
]);
echo  "    </div>\n\n";
