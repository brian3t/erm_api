...
<div class="offer-form">
    ...
    <?= $form->field($model, 'offer_type', ['options'=>['class'=>'form-group col-sm-5']])->dropDownList(['Icon' => 'Icon', 'Co-Pro Promoter' => 'Co-Pro Promoter', 'Co-Pro Venue' => 'Co-Pro Venue', '3rd Party' => '3rd Party',], ['prompt' => '']) ?>
    ...
    <?= $form->field($model, 'doors', ['options'=>['class'=>'form-group col-sm-5']])->widget(TimePicker::className(), [
        'options' => [
            'pluginOptions' => [
    ...
    <?= $form->field($model, 'showtime', ['options'=>['class'=>'form-group col-sm-5']])->widget(TimePicker::className(), [
        'options' => [
            'pluginOptions' => [
    ...
    <?= $form->field($model, 'notes', ['options'=>['class'=>'form-group col-sm-10']])->textInput(['maxlength' => true, 'placeholder' => 'Notes']) ?>
    ...
    <?= $form->field($model, 'tax_note', ['options'=>['class'=>'form-group col-sm-3']])->textInput(['maxlength' => true, 'placeholder' => 'Tax Note']) ?>
    ...
    <?= $form->field($model, 'facility_fee_note', ['options'=>['class'=>'form-group col-sm-5']])->textInput(['maxlength' => true, 'placeholder' => 'Facility Fee Note']) ?>
    ...
    <?= $form->field($model, 'artist_offer_type', ['options'=>['class'=>'form-group col-sm-4']])->dropDownList(['Guarantee' => 'Guarantee', 'Split' => 'Split', 'Plus' => 'Plus', 'Vs.' => 'Vs.', 'Backend' => 'Backend',], ['prompt' => '']) ?>
    ...
    <?= $form->field($model, 'expense_application', ['options'=>['class'=>'form-group col-sm-5']])->dropDownList(['Net' => 'Net', 'Gross' => 'Gross',], ['prompt' => '']) ?>
    ...
    <?= $form->field($model, 'radius_clause_metric', ['options'=>['class'=>'form-group col-sm-2']])->dropDownList(['Miles' => 'Miles', 'KM' => 'KM',], ['prompt' => '']) ?>
    
    <?= $form->field($model, 'pre_show_lockout', ['options'=>['class'=>'form-group col-sm-2']])->textInput(['placeholder' => 'Pre Show Lockout']) ?>
    
    <?= $form->field($model, 'pre_show_lockout_unit', ['options'=>['class'=>'form-group col-sm-3']])->dropDownList(['Days' => 'Days', 'Months' => 'Months',], ['prompt' => '']) ?>
    
    <?= $form->field($model, 'post_show_lockout', ['options'=>['class'=>'form-group col-sm-5']])->textInput(['placeholder' => 'Post Show Lockout']) ?>
    
    <?= $form->field($model, 'post_show_lockout_unit', ['options'=>['class'=>'form-group col-sm-5']])->dropDownList(['Days' => 'Days', 'Months' => 'Months',], ['prompt' => '']) ?>
    
    <?= $form->field($model, 'artist_deal_note', ['options'=>['class'=>'form-group col-sm-10']])->textInput(['maxlength' => true, 'placeholder' => 'Artist Deal Note']) ?>
    ...
    <?= $form->field($model, 'general_expense_note', ['options'=>['class'=>'form-group col-sm-10']])->textInput(['maxlength' => true, 'placeholder' => 'General Expense Note']) ?>
    ...
    <?= $form->field($model, 'merch_buyout_venue_sell', ['options'=>['class'=>'form-group col-sm-5']])->textInput(['maxlength' => true, 'placeholder' => 'Merch Buyout Venue Sell']) ?>
    
    <?= $form->field($model, 'merch_buyout_artist_sell', ['options'=>['class'=>'form-group col-sm-5']])->textInput(['maxlength' => true, 'placeholder' => 'Merch Buyout Artist Sell']) ?>
    
    <?= $form->field($model, 'merch_artist_split_venue_sell', ['options'=>['class'=>'form-group col-sm-5']])->textInput(['maxlength' => true, 'placeholder' => 'Merch Artist Split Venue Sell']) ?>
    
    <?= $form->field($model, 'merch_artist_split_artist_sell', ['options'=>['class'=>'form-group col-sm-5']])->textInput(['maxlength' => true, 'placeholder' => 'Merch Artist Split Artist Sell']) ?>
    
    <?= $form->field($model, 'merch_artist_split_media_venue_sell', ['options'=>['class'=>'form-group col-sm-5']])->textInput(['maxlength' => true, 'placeholder' => 'Merch Artist Split Media Venue Sell']) ?>
    
    <?= $form->field($model, 'merch_artist_split_media_artist_sell', ['options'=>['class'=>'form-group col-sm-5']])->textInput(['maxlength' => true, 'placeholder' => 'Merch Artist Split Media Artist Sell']) ?>
    
    <?= $form->field($model, 'merch_note', ['options'=>['class'=>'form-group col-sm-10']])->textInput(['maxlength' => true, 'placeholder' => 'Merch Note']) ?>
    
    <?= $form->field($model, 'artist_comp', ['options'=>['class'=>'form-group col-sm-5']])->textInput(['placeholder' => 'Artist Comp']) ?>
    
    <?= $form->field($model, 'artist_comp_note', ['options'=>['class'=>'form-group col-sm-5']])->textInput(['maxlength' => true, 'placeholder' => 'Artist Comp Note']) ?>
    
    <?= $form->field($model, 'production_comp', ['options'=>['class'=>'form-group col-sm-5']])->textInput(['placeholder' => 'Production Comp']) ?>
    
    <?= $form->field($model, 'production_comp_note', ['options'=>['class'=>'form-group col-sm-5']])->textInput(['maxlength' => true, 'placeholder' => 'Production Comp Note']) ?>
    
    <?= $form->field($model, 'promotional_comp', ['options'=>['class'=>'form-group col-sm-5']])->textInput(['placeholder' => 'Promotional Comp']) ?>
    
    <?= $form->field($model, 'promotional_comp_note', ['options'=>['class'=>'form-group col-sm-5']])->textInput(['maxlength' => true, 'placeholder' => 'Promotional Comp Note']) ?>
    
    <?= $form->field($model, 'house_comp', ['options'=>['class'=>'form-group col-sm-5']])->textInput(['placeholder' => 'House Comp']) ?>
    
    <?= $form->field($model, 'house_comp_note', ['options'=>['class'=>'form-group col-sm-5']])->textInput(['maxlength' => true, 'placeholder' => 'House Comp Note']) ?>
    
    <?= $form->field($model, 'kill', ['options'=>['class'=>'form-group col-sm-5']])->textInput(['placeholder' => 'Kill']) ?>
    
    <?= $form->field($model, 'kill_note', ['options'=>['class'=>'form-group col-sm-5']])->textInput(['maxlength' => true, 'placeholder' => 'Kill Note']) ?>
    
    <?= $form->field($model, 'comp_kill_note', ['options'=>['class'=>'form-group col-sm-10']])->textInput(['maxlength' => true, 'placeholder' => 'Comp Kill Note']) ?>
