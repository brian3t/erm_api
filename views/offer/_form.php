...
<div class="offer-form">
    ...
    <?= $form->field($model, 'merch_artist_split_media_venue_sell', ['options' => ['class' => 'form-group col-sm-5']])->textInput([
        'maxlength' => true,
        'placeholder' => 'Merch Artist Split Media Venue Sell'
    ]) ?>
    
    <?= $form->field($model, 'merch_artist_split_media_artist_sell', ['options' => ['class' => 'form-group col-sm-5']])->textInput([
        'maxlength' => true,
        'placeholder' => 'Merch Artist Split Media Artist Sell'
    ]) ?>
    
    <?= $form->field($model, 'merch_note', ['options' => ['class' => 'form-group col-sm-10']])->textarea(['maxlength' => true, 'placeholder' => 'Merch Note']) ?>
