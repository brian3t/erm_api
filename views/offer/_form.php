...
<div class="offer-form">
    ...
    <?= $form->field($model,'offer_type',['options'=>['class'=>'form-group col-sm-5']])->dropDownList(['Icon'=>'Icon','Co-Pro Promoter'=>'Co-Pro Promoter','Co-Pro Venue'=>'Co-Pro Venue','3rd Party'=>'3rd Party',],['prompt'=>null]) ?>
    ...
    <!--    --><?php //= $form->field($model, 'showtime', ['options'=>['class'=>'form-group col-sm-5']])->widget(TimePicker::className(), [
    //        'options' => [
    //            'pluginOptions' => [
    ...
    <?= $form->field($model,'artist_offer_type',['options'=>['class'=>'form-group col-sm-4']])->dropDownList(['Guarantee'=>'Guarantee','Split'=>'Split','Plus'=>'Plus','Vs.'=>'Vs.','Backend'=>'Backend',],['prompt'=>null]) ?>
    ...
    <?= $form->field($model,'expense_application',['options'=>['class'=>'form-group col-sm-5']])->dropDownList(['Net'=>'Net','Gross'=>'Gross',],['prompt'=>null]) ?>
    ...
    <?= $form->field($model,'radius_clause_metric',['options'=>['class'=>'form-group col-sm-2']])->dropDownList(['Miles'=>'Miles','KM'=>'KM',],['prompt'=>null]) ?>

    <?= $form->field($model,'pre_show_lockout',['options'=>['class'=>'form-group col-sm-2']])->textInput(['placeholder'=>'Pre Show Lockout']) ?>

    <?= $form->field($model,'pre_show_lockout_unit',['options'=>['class'=>'form-group col-sm-3']])->dropDownList(['Days'=>'Days','Months'=>'Months',],['prompt'=>null]) ?>

    <?= $form->field($model,'post_show_lockout',['options'=>['class'=>'form-group col-sm-5']])->textInput(['placeholder'=>'Post Show Lockout']) ?>

    <?= $form->field($model,'post_show_lockout_unit',['options'=>['class'=>'form-group col-sm-5']])->dropDownList(['Days'=>'Days','Months'=>'Months',],['prompt'=>null]) ?>
