...
class OrderSearch extends Order
{
    ...
    {
        return [
            [['id', 'mp_id', 'rop_order_id', 'force_rop_resend', 'count_rop_pull'], 'integer'],
            [['mp_reference_number', 'last_mp_updated', 'last_rop_pull', 'order_date_time', 'name', 'company', 'email', 'address', 'address2', 'city', 'state', 'zip', 'country', 'phone', 'ship_name', 'ship_company', 'ship_address', 'ship_address2', 'ship_city', 'ship_state', 'ship_zip', 'ship_country', 'ship_phone', 'pay_type', 'pay_transaction_id', 'comments', 'shipping', 'status', 'note'], 'safe'],
