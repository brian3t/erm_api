...
/**
 * This is the base model class for table "mk_internet".
 *
 * @property integer $id
 ...
 */
class MkInternet extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    {
        return $this->hasOne(\app\models\Marketing::className(), ['id' => 'marketing_id'])->inverseOf('mkInternets');
    }
    ...
    {
        return $this->hasOne(\app\models\Company::className(), ['id' => 'company_id'])->inverseOf('mkInternets');
    }
    }
